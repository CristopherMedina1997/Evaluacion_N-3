 ...
 */
package com.mycompany.user.forms;

import com.mycompany.user.model.UserEntity;
import com.mycompany.user.repository.IUserRepository;
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        try {
            ...
            if(validate != null && validate.getId() != null){
                JOptionPane.showMessageDialog(this, "Se valido el usuario");
            } else {
                 JOptionPane.showMessageDialog(this, "no se encontro el usuario");
            }
        } catch (SQLException ex) {
            Logger.getLogger(LoginForms.class.getName()).log(Level.SEVERE, null, ex);
        }
